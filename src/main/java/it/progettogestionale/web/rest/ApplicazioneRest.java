...
//	}
	...
	public ResponseEntity<LogFileAppDTO> modificaApp (@RequestBody LogFileAppDTO modifica){
		...
		if(a.getIdApplicazione() != null) {
			...
			lfa.setIdLogApp(modifica.getIdApplicazione());
			lfa.setNodoConsole(modifica.getNodoConsole());
			lfa.setLaunchingMeetingDataGatheringStarting(modifica.getLaunchingMeetingDataGatheringStarting());
			lfa.setAvgAnalysisTime(modifica.getAvgAnalysisTime());
			lfa.setAutomationEnablingDate(modifica.getAutomationEnablingDate());
			lfa.setDone(modifica.getDone());
			lfa.setApmCode(modifica.getApmCode());
			lfa.setInsertedInCastProgram(modifica.getInsertedInCastProgram());
			lfa.setStakeholderEngagement(modifica.getStakeholderEngagement());
			lfa.setStakeholderBrief(modifica.getStakeholderBrief());
			lfa.setOnBoardingKitDelivery(modifica.getOnBoardingKitDelivery());
			lfa.setPrimaRestitution(modifica.getPrimaRestitution());
		    lfa.setOwnerOnboarding(modifica.getOwnerOnboarding());
			lfa.setOwnerAFP(modifica.getOwnerAFP());
			lfa.setGdsUnit(modifica.getGdsUnit());
			lfa.setTecnologia(modifica.getTecnologia());
			lfa.setServerManager(modifica.getServerManager());
			lfa.setSoloCMS(modifica.getSoloCMS());
			lfa.setMacchina(modifica.getMacchina());
			lfa.setNoteOnboarding(modifica.getNoteOnboarding());
			lfa.setFase(modifica.getFase());
			lfa.setAfpStatus(modifica.getAfpStatus());
			lfa.setPubblicatoDashboard(modifica.getPubblicatoDashboard());
			lfa.setNoteAppOwner(modifica.getNoteOnboarding());
			lfa.setJiraautomationActivation(modifica.getJiraautomationActivation());
			lfa.setRepoAvailability(modifica.getRepoAvailability());
			lfa.setAutomationStatus(modifica.getAutomationStatus());
			lfa.setAutomationNotes(modifica.getAutomationNotes());
			lfa.setGreenItIndex(modifica.getGreenItIndex());
			lfa.setOnboardingKitClosing(modifica.getOnboardingKitClosing());
			lfa.setSourceCodeFinalDelivery(modifica.getSourceCodeFinalDelivery());
			lfa.setLinkConfluence(modifica.getLinkConfluence());
			lfa.setBusinessCriticality(modifica.getBusinessCriticality());
			lfa.setDevMethodology(modifica.getDevMethodology());
			lfa.setProvider(modifica.getProvider());
